...
def main() -> None:
    ...
    print("  - Apply MAD, z-score, clipping, or another fallback")
    print()
    print("When IQR is exactly zero, Tukey conservatively keeps every value")
    print("and reports the observed minimum and maximum as effective bounds.")
    print()
